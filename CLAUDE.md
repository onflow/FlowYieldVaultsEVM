...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository. It is used for automated code reviews and development assistance.
